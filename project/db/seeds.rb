...
User.create(profile_image:'imagen user', nickname:'Julio Alonso' ,biography:'King of complain' ,email:'jjalonso@miuandes.cl' ,password:'123456789' ,country:'Chile' ,city:'Santiago' ,status:'Available' ,gps_location:'My home', admin_id: 1 ,super_admin_id: 1, role: 'admin')
Wall.create()
